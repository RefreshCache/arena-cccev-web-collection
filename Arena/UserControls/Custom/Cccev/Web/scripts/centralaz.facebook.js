(function() {
  ...
  CentralAZ.Facebook.Controllers.FacebookConnectRouter = (function(_super) {

    __extends(FacebookConnectRouter, _super);
    ...
    FacebookConnectRouter.prototype.initialize = function(options) {
      if (options.model) this.user = options.model;
  ...
  CentralAZ.Facebook.Controllers.FacebookLoginRouter = (function(_super) {

    __extends(FacebookLoginRouter, _super);
    ...
    FacebookLoginRouter.prototype.onLogin = function(response) {
      ...
      if (!response) return this.navigate('!/log-in', true);
      this.user = new CentralAZ.Facebook.Models.FacebookUser(response);
  ...
  facebookEvents.bind('arenaLogin', function(onSuccess, onError) {
    ...
    if (onSuccess == null) onSuccess = facebookEvents.defaults.onLoginSuccess;
    if (onError == null) onError = facebookEvents.defaults.onError;
  ...
  facebookEvents.bind('facebookLogOut', function() {
    if (FB) return FB.logout();
  });

  facebookEvents.bind('connectAccounts', function(onSuccess, onError) {
    var accessToken, state;
    if (onSuccess == null) onSuccess = facebookEvents.defaults.onConnectSuccess;
    if (onError == null) onError = facebookEvents.defaults.onError;
    accessToken = CentralAZ.Facebook.Helpers.Authentication.config.accessToken;
    state = CentralAZ.Facebook.Helpers.Authentication.config.state;
    return $.ajax({
  ...
  facebookEvents.bind('optOut', function(onSuccess, onError) {
    var state;
    if (onSuccess == null) onSuccess = facebookEvents.defaults.onOptOutSuccess;
    if (onError == null) onError = facebookEvents.defaults.onError;
    state = CentralAZ.Facebook.Helpers.Authentication.config.state;
    return $.ajax({
  ...
  CentralAZ.Facebook.Models.FacebookUser = (function(_super) {
  ...
  CentralAZ.Facebook.Models.FacebookUsers = (function(_super) {

    __extends(FacebookUsers, _super);
  ...
  CentralAZ.Facebook.Views.Connected = (function(_super) {
    ...
    Connected.prototype.render = function() {
      ...
      return $el.fadeIn('fast', function() {
        return setTimeout(function() {
          return $el.fadeOut('fast', function() {
            return _this.remove();
          });
        }, 5000);
      });
  ...
  CentralAZ.Facebook.Views.FacebookConnectAccount = (function(_super) {

    __extends(FacebookConnectAccount, _super);
  ...
  CentralAZ.Facebook.Views.FacebookLogin = (function(_super) {

    __extends(FacebookLogin, _super);

    function FacebookLogin() {
      this.setElement('#log-in');
      this.unbind();
  ...
  CentralAZ.Facebook.Views.FacebookSignUp = (function(_super) {

    __extends(FacebookSignUp, _super);

    function FacebookSignUp() {
      this.setElement('#signup-form');
  ...
  CentralAZ.Facebook.Views.FacebookWelcome = (function(_super) {

    __extends(FacebookWelcome, _super);

    function FacebookWelcome() {
      this.setElement('#user-info');
