<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HasselhoffSearchConnector.ascx.cs" Inherits="ArenaWeb.UserControls.Custom.Cccev.Web2.HasselhoffSearchConnector" %>

<asp:Panel id="pnlQuickSearch" runat="server" DefaultButton="ibGo" class="subscribe">
    <asp:ImageButton ID="ibGo" runat="server" CssClass="searchBtn" OnClick="btnGo_Click" />
