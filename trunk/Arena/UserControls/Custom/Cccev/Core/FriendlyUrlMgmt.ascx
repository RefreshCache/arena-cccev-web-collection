...
<asp:UpdatePanel runat="server" ID="updAddRemoveForm" UpdateMode="Always">
	<ContentTemplate>
...
<br />
<asp:UpdatePanel runat="server" ID="updVDGrid" UpdateMode="Always">
	<ContentTemplate>
		<Arena:DataGrid ID="grdVirtualDirectoryList" runat="server" AutoGenerateColumns="False"
			...
			<Columns>
				...
				<asp:TemplateColumn HeaderText="Size(50-1000) - Get QR Code" HeaderStyle-Font-Bold="true"
